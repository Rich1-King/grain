...
namespace CornPeatsTeXingDataMember
{
    class SqlData
    {
        ...
        public static List<string> sqlDataStringValue(string TableName, string row, string str)
        {
            List<string> strGrainTemp = new List<string>();
            ...
            while (dr.Read())
            {
                strGrainTemp.Add(Convert.ToString(dr[row]));
            }
