...
namespace IGDataChart.Controls
{
    public class ChartToolbarPanel : Control
    {
        ...
        private void Refresh()
        {
            ...
            {
                this.PanModeButton.IsChecked = DataChart != null && DataChart.DefaultInteraction == InteractionState.DragPan && (DataChart.HorizontalZoomable || DataChart.VerticalZoomable);
                this.PanModeButton.IsEnabled = DataChart != null && (DataChart.HorizontalZoomable || DataChart.VerticalZoomable);
            }

            if (this.ZoomModeButton != null)
            {
                this.ZoomModeButton.IsChecked = DataChart != null && DataChart.DefaultInteraction == InteractionState.DragZoom && (DataChart.HorizontalZoomable || DataChart.VerticalZoomable);
                this.ZoomModeButton.IsEnabled = DataChart != null && (DataChart.HorizontalZoomable || DataChart.VerticalZoomable);
            }
            ...
            {
                this.FitHorizontalButton.Visibility = DataChart != null && DataChart.HorizontalZoomable ? Visibility.Visible : Visibility.Collapsed;
            }

            if (this.FitVerticalButton != null)
            {
                this.FitVerticalButton.Visibility = DataChart != null && DataChart.VerticalZoomable ? Visibility.Visible : Visibility.Collapsed;
            }

            if (this.FitAllButton != null)
            {
                this.FitAllButton.Visibility = DataChart != null && DataChart.HorizontalZoomable && DataChart.VerticalZoomable ? Visibility.Visible : Visibility.Collapsed;
            }
        }
    }
