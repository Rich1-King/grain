...
namespace ScatterDiagram
{
    ...
    public partial class SpeedDataWindow : Infragistics.Samples.Framework.SampleContainer
    {
        DataSource Axis;
        DataSource yData;
        ...
        private void Grid_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            labTitle.Content = "常温条件下当初始虫口密度2头/kg储粮害虫米象种群的增长速率";
            wheatePeatsZongQunHeader.miaoShu.Document = convertToBox.convertStringToFlowDocument(model2.chartSpeedMiaoShu);
        }
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (but == butCorn)
            {
                ...
                labTitle.Content = "常温条件下当初始虫口密度2头/kg储粮害虫谷蠹种群的增长速率图";
                wheatePeatsZongQunHeader.miaoShu.Document = convertToBox.convertStringToFlowDocument(model1.chartSpeedMiaoShu);
            }
            ...
            if (but == butGrain)
            {
                ...
                labTitle.Content = "常温条件下当初始虫口密度2头/kg储粮害虫玉米象种群的增长速率";
                wheatePeatsZongQunHeader.miaoShu.Document = convertToBox.convertStringToFlowDocument(model.chartSpeedMiaoShu);
            }
            if (but == butTcc)
            {
                if (colCorn != null && colCorn.Visibility == Visibility.Visible)
                ...
                labTitle.Content = "常温条件下当初始虫口密度2头/kg储粮害虫赤拟谷盗种群的增长速率";
                wheatePeatsZongQunHeader.miaoShu.Document = convertToBox.convertStringToFlowDocument(model3.chartSpeedMiaoShu);
            }
        }
