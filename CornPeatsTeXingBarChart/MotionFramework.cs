...
namespace CornPeatsTeXingBarChart
{
    /// <summary>
    ...
    public class MotionFramework : ObservableModel
    {
        ...
        private void UpdateMotionSeries(Series series, DataPoint dataPoint)
        {
            ...
            ((IList<MotionDataPoint>)series.ItemsSource)[0].ValueHum = dataPoint.ValueHum;
            ((IList<MotionDataPoint>)series.ItemsSource)[0].ValueminTem = dataPoint.ValueminTem;
            ((IList<MotionDataPoint>)series.ItemsSource)[0].ValuemaxTem = dataPoint.ValuemaxTem;
    ...
    public class DataPoint
    {
        ...
        public double ValueminTem { set; get; }
        public double ValuemaxTem { set; get; }
        public double ValueHum { set; get; }
    }
    ...
    public class MotionDataPoint : ObservableModel
    {
        ...
        private double _valuemintem;
        private double _valuemaxtem;
        private double _valuetem;
        ...
        public static string PropertyNameValueMinTem = "ValueminTem";
        public static string PropertyNameValueMaxTem = "ValuemaxTem";
        public static string PropertyNameValueHum = "ValueHum";
        public double ValueminTem
        {
            get { return _valuemintem; }
            set { if (_valuemintem == value) return; _valuemintem = value; this.OnPropertyChanged(PropertyNameValueMinTem); }
        }
        public double ValuemaxTem
        {
            get { return _valuemaxtem; }
            set { if (_valuemaxtem == value) return; _valuemaxtem = value; this.OnPropertyChanged(PropertyNameValueMaxTem); }
        }
        public double ValueHum
        {
            get { return _valuetem; }
            set { if (_valuetem == value) return; _valuetem = value; this.OnPropertyChanged(PropertyNameValueHum); }
        }
