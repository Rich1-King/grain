...
namespace CornPeatsTeXingDongTaiChart
{
    ...
    public class MotionFramework : ObservableModel
    {
        ...
        private void UpdateMotionSeries(Series series, DataPoint dataPoint)
        {
            ...
            ((IList<MotionDataPoint>)series.ItemsSource)[0].ValueOfTem = dataPoint.ValueOfTem;
        ...
        public int CurrentElementShown
        {
            ...
            set
            {
                ...
                //this.CurrentDateTimeString = this.CurrentDateTime.ToShortDateString()+"  "+this.CurrentDateTime.ToShortTimeString();
                this.CurrentDateTimeString = String.Format("{0:MM/dd}", this.CurrentDateTime);
            }
        }
    ...
    public class MotionDataPoint : ObservableModel
    {
        ...
        public static string PropertyNameValueMaxTem = "ValueOfTem";
    
        public string ValueOfTem
        {
            get { return _valueoftem; }
            set { if (_valueoftem == value) return; _valueoftem = value; this.OnPropertyChanged(PropertyNameValueMaxTem); }
        }
