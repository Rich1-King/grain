...
namespace ZhiLiangCanShuScatterDiagram
{
    ...
    public partial class SpeedDataWindow : Page
    {
        ...
        private void OnCategoryChartMouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (((XamDataChart)series.SeriesViewer).Axes.OfType<CategoryDateTimeXAxis>().Any())
            {
                ...
                this.CategoryYCoordinateTextBlock.Text = String.Format("{0:0.0000}", unscaledY);

                textCornY1.Text = String.Format("{0:0.0000}", unscaledY);
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            labTitle.Content = "储藏过程中小麦不完善度增加速率的变化情况";
